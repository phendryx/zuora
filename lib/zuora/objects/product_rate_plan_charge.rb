module Zuora::Objects
  ...
  class ProductRatePlanCharge < Base
    ...
    PRICE_CHANGE_OPTIONS = %w(NoChange SpecificPercentageValue UseLatestProductCatalogPricing)
    ...
    validates_inclusion_of :price_change_option, :in => PRICE_CHANGE_OPTIONS, :allow_nil => true
